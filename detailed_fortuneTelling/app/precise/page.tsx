...
import { calcPreciseScore, TIMINGS, PreciseScoreResult } from '@/lib/scoring'
...
import { getPreciseKansen } from '@/lib/kansen'
...
function PaymentForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await stripe.confirmPayment({
      elements,
      confirmParams: {
        return_url: `${window.location.origin}/precise?payment_success=true`,
      },
