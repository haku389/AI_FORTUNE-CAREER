      ...
      <div style={{ ...pageStyle, justifyContent: 'center' }}>
        ...
        {!lineUserId ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
            ...
            {isInAppBrowser && (
              <div style={{ background: '#131020', border: '1px solid #a898f844', borderRadius: 10, padding: '10px 14px', marginBottom: 12, width: '100%', boxSizing: 'border-box' }}>
                <div style={{ fontSize: 11, color: '#a898f8', lineHeight: 1.7 }}>
                  💡 うまくいかない場合は、右上メニューの<strong style={{ color: '#f0f4ff' }}>「Safariで開く」</strong>をお試しください
                </div>
              </div>
            )}
            <a
            ...
            <p style={{ fontSize: 10, color: '#5a6a9a', marginTop: 12, textAlign: 'center' }}>
              ログインすることで<a href="/terms" style={{ color: '#7888b8' }}>利用規約</a>・<a href="/privacy" style={{ color: '#7888b8' }}>プライバシーポリシー</a>に同意したものとみなされます
            </p>
          </div>
        ) : (
          <>
