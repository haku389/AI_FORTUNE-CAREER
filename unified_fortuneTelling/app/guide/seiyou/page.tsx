...
export const metadata: Metadata = {
  ...
  description: '西洋占星術の太陽星座・月星座・木星・土星が転職にどう影響するかを解説。玲子の転職鑑定で重視する3つの天体の見方がわかります。',
}
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 13, color: '#8898c8', lineHeight: 2, maxWidth: 340, margin: '0 auto' }}>
            西洋占星術は、生まれた瞬間の天体配置をもとに、性格・運命・転職タイミングを読み解く占術です。古代バビロニアに起源を持ち、ギリシャ・ローマを経て現代まで受け継がれてきた数千年の知恵が凝縮されています。天体はそれぞれ異なるエネルギーを持ち、あなたの出生時にどの星座にあったかで、生まれ持った資質や人生のテーマが浮かび上がります。玲子の鑑定では特に「太陽星座」「月星座」「木星・土星の動き」の3つを重視し、転職の方向性とベストなタイミングを読み解きます。
          </p>
        </div>
      </div>
