export type AnswerScore = {
  ...
  current_income?: string;  // 現在の年収レンジ（Q16.5）
...
export const QUESTIONS: Question[] = [
  // ── BLOCK 1: 土星が刻む「今の場所と時間」 ──
  {
    ...
    tag: '🪐 土星が問う — 魂の消耗度',
    planet: '土星',
    q: '今の職場に「もう限界かも」と感じ始めたのはいつ頃からですか？',
    hint: '土星は「忍耐と試練」を司る惑星。あなたの正直な感覚が最も精度の高い手がかりになります。',
    opts: [
  ...
  },
  {
    ...
    tag: '🌑 月が映す — 本音の深さ',
    planet: '月',
    q: '仕事の悩みを、誰かに打ち明けられないまま心の奥にしまっていることはありますか？',
  ...
  },
  {
    ...
    tag: '☿ 水星が見る — 才能の使われ方',
    planet: '水星',
    q: '今の職場で「自分の得意なことが活かせている」と感じる場面はどんな時ですか？',
  ...
  },
  {
    ...
    tag: '🪐 土星が刻む — 時間の積み重ね',
    planet: '土星',
    q: '今の職場に何年いらっしゃいますか？また、転職は今回が何回目になりますか？',
  ...
  // ── BLOCK 2: キャリア未来鑑定士が読み解く「魂の色」 ──
  {
    ...
    tag: '☿ 水星が映す — 思考の星型',
    planet: '水星',
    q: 'あなたのMBTIタイプはどれですか？わからない場合は、直感で一番しっくりくるものを選んでください',
  ...
  },
  {
    ...
    tag: '♀ 金星が問う — 魂が喜ぶ瞬間',
    planet: '金星',
    q: '仕事の中で「時間を忘れるほど没頭できる」のは、どんな瞬間ですか？',
  ...
  },
  {
    ...
    planet: '火星',
    q: '締め切りや急なトラブルが来たとき、あなたの星はどう反応するでしょうか？',
  ...
  },
  {
    ...
    tag: '🪐 土星が示す — 理想のリーダー像',
    planet: '土星',
    q: '上司にするなら、どんなタイプの人のもとで一番力を発揮できますか？',
  ...
  },
  {
    ...
    tag: '☀️ 太陽が問う — 直感か論理か',
    planet: '太陽',
    q: '大事な決断をするとき、あなたの太陽はどちらに光を当てるでしょうか？',
  ...
  },
  {
    ...
    tag: '♃ 木星が開く — 引き寄せられる世界',
    planet: '木星',
    q: '星の引力に従うとしたら、次のステージで飛び込みたい業界はどこですか？（複数選択可）',
  ...
  },
  {
    ...
    planet: '木星',
    q: '次のステージで担いたい仕事の役割は何ですか？（複数選択可）',
    hint: '木星は「使命と才能の開花」を告げる惑星。あなたが輝ける役割を直感で選んでみてくださいね。',
    multi: true,
    opts: [
      // 常時表示（業界問わず）
  ...
  },
  {
    ...
    multi: true,
    opts: [
      { sym: 'Globe', main: 'エリアにはこだわらない', hint: '全国・リモートも含め幅広く',                           s: { area: 'any' } },
      { sym: 'MapPin', main: '北海道・東北地方',         hint: '北海道・青森・岩手・宮城・秋田・山形・福島',           s: { area: 'hokkaido_tohoku' } },
      { sym: 'MapPin', main: '関東地方',               hint: '東京・神奈川・埼玉・千葉・茨城・栃木・群馬',           s: { area: 'kanto' } },
      { sym: 'MapPin', main: '中部地方',               hint: '新潟・富山・石川・福井・山梨・長野・岐阜・静岡・愛知', s: { area: 'chubu' } },
      { sym: 'MapPin', main: '近畿地方',               hint: '三重・滋賀・京都・大阪・兵庫・奈良・和歌山',           s: { area: 'kinki' } },
      { sym: 'MapPin', main: '中国地方',               hint: '鳥取・島根・岡山・広島・山口',                         s: { area: 'chugoku' } },
      { sym: 'MapPin', main: '四国地方',               hint: '徳島・香川・愛媛・高知',                               s: { area: 'shikoku' } },
      { sym: 'MapPin', main: '九州・沖縄地方',         hint: '福岡・佐賀・長崎・熊本・大分・宮崎・鹿児島・沖縄',     s: { area: 'kyushu_okinawa' } },
    ],
  },
  {
    block: 3,
    ...
    multi: true,
    opts: [
      { sym: 'Globe', main: 'こだわらない', hint: '都道府県の指定なし', s: { prefecture: 'any' } },
      // 北海道・東北
      { sym: 'MapPin', main: '北海道', hint: '', s: { prefecture: '北海道' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '青森県', hint: '', s: { prefecture: '青森県' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '岩手県', hint: '', s: { prefecture: '岩手県' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '宮城県', hint: '', s: { prefecture: '宮城県' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '秋田県', hint: '', s: { prefecture: '秋田県' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '山形県', hint: '', s: { prefecture: '山形県' }, relatedAreas: ['hokkaido_tohoku'] },
      { sym: 'MapPin', main: '福島県', hint: '', s: { prefecture: '福島県' }, relatedAreas: ['hokkaido_tohoku'] },
      // 関東
      { sym: 'MapPin', main: '東京都',   hint: '', s: { prefecture: '東京都' },   relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '神奈川県', hint: '', s: { prefecture: '神奈川県' }, relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '埼玉県',   hint: '', s: { prefecture: '埼玉県' },   relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '千葉県',   hint: '', s: { prefecture: '千葉県' },   relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '茨城県',   hint: '', s: { prefecture: '茨城県' },   relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '栃木県',   hint: '', s: { prefecture: '栃木県' },   relatedAreas: ['kanto'] },
      { sym: 'MapPin', main: '群馬県',   hint: '', s: { prefecture: '群馬県' },   relatedAreas: ['kanto'] },
      // 中部
      { sym: 'MapPin', main: '新潟県', hint: '', s: { prefecture: '新潟県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '富山県', hint: '', s: { prefecture: '富山県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '石川県', hint: '', s: { prefecture: '石川県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '福井県', hint: '', s: { prefecture: '福井県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '山梨県', hint: '', s: { prefecture: '山梨県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '長野県', hint: '', s: { prefecture: '長野県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '岐阜県', hint: '', s: { prefecture: '岐阜県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '静岡県', hint: '', s: { prefecture: '静岡県' }, relatedAreas: ['chubu'] },
      { sym: 'MapPin', main: '愛知県', hint: '', s: { prefecture: '愛知県' }, relatedAreas: ['chubu'] },
      // 近畿
      { sym: 'MapPin', main: '三重県',   hint: '', s: { prefecture: '三重県' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '滋賀県',   hint: '', s: { prefecture: '滋賀県' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '京都府',   hint: '', s: { prefecture: '京都府' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '大阪府',   hint: '', s: { prefecture: '大阪府' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '兵庫県',   hint: '', s: { prefecture: '兵庫県' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '奈良県',   hint: '', s: { prefecture: '奈良県' },   relatedAreas: ['kinki'] },
      { sym: 'MapPin', main: '和歌山県', hint: '', s: { prefecture: '和歌山県' }, relatedAreas: ['kinki'] },
      // 中国地方
      { sym: 'MapPin', main: '鳥取県', hint: '', s: { prefecture: '鳥取県' }, relatedAreas: ['chugoku'] },
      { sym: 'MapPin', main: '島根県', hint: '', s: { prefecture: '島根県' }, relatedAreas: ['chugoku'] },
      { sym: 'MapPin', main: '岡山県', hint: '', s: { prefecture: '岡山県' }, relatedAreas: ['chugoku'] },
      { sym: 'MapPin', main: '広島県', hint: '', s: { prefecture: '広島県' }, relatedAreas: ['chugoku'] },
      { sym: 'MapPin', main: '山口県', hint: '', s: { prefecture: '山口県' }, relatedAreas: ['chugoku'] },
      // 四国
      { sym: 'MapPin', main: '徳島県', hint: '', s: { prefecture: '徳島県' }, relatedAreas: ['shikoku'] },
      { sym: 'MapPin', main: '香川県', hint: '', s: { prefecture: '香川県' }, relatedAreas: ['shikoku'] },
      { sym: 'MapPin', main: '愛媛県', hint: '', s: { prefecture: '愛媛県' }, relatedAreas: ['shikoku'] },
      { sym: 'MapPin', main: '高知県', hint: '', s: { prefecture: '高知県' }, relatedAreas: ['shikoku'] },
      // 九州・沖縄
      { sym: 'MapPin', main: '福岡県',   hint: '', s: { prefecture: '福岡県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '佐賀県',   hint: '', s: { prefecture: '佐賀県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '長崎県',   hint: '', s: { prefecture: '長崎県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '熊本県',   hint: '', s: { prefecture: '熊本県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '大分県',   hint: '', s: { prefecture: '大分県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '宮崎県',   hint: '', s: { prefecture: '宮崎県' },   relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '鹿児島県', hint: '', s: { prefecture: '鹿児島県' }, relatedAreas: ['kyushu_okinawa'] },
      { sym: 'MapPin', main: '沖縄県',   hint: '', s: { prefecture: '沖縄県' },   relatedAreas: ['kyushu_okinawa'] },
    ],
  },
  {
    block: 3,
    tag: '⛢ 天王星が呼ぶ — 変革への渇望',
    planet: '天王星',
    q: '転職とは別に、副業・フリーランス・起業といった「自分の可能性を広げる動き」に興味はありますか？',
  ...
  },
  {
    ...
    tag: '♀ 金星が知る — 今の豊かさの座標',
    planet: '金星',
    q: '差し支えなければ、現在の年収を教えていただけますか？',
    hint: '金星は「今の豊かさ」を映す惑星。現在地を知ることで、より精度の高い転職先のマッチングができます。答えたくない場合は「回答しない」を選んでくださいね。',
    opts: [
      { sym: 'Sprout',     main: '300万円未満',        hint: '', s: { current_income: 'under_300' } },
      { sym: 'Leaf',       main: '300〜500万円未満',   hint: '', s: { current_income: '300_500' } },
      { sym: 'TrendingUp', main: '500〜700万円未満',   hint: '', s: { current_income: '500_700' } },
      { sym: 'Gem',        main: '700〜1000万円未満',  hint: '', s: { current_income: '700_1000' } },
      { sym: 'Trophy',     main: '1000万円以上',       hint: '', s: { current_income: '1000_plus' } },
      { sym: 'HelpCircle', main: '回答しない',          hint: '', s: { current_income: 'undisclosed' } },
    ],
  },
  {
    block: 3,
  ...
  // ── BLOCK 4: 月が守る「魂の居場所」 ──
  {
    ...
    tag: '🌙 月が安らぐ — 魂が解放される環境',
    planet: '月',
    q: '月があなたに「ここが正しい場所だ」と告げるのは、どんな働き方をしている時ですか？',
  ...
  },
  {
    ...
    planet: '木星',
    q: '木星があなたの才能を最も輝かせる職場の規模感はどれですか？',
  ...
  // ── BLOCK 5: 星が映す「隠れた自分」 ──
  {
    ...
    tag: '🪐 土星が測る — 自分の市場価値',
    planet: '土星',
    q: '今の自分のスキルや経験について、土星の目で正直に見るとどう思いますか？',
  ...
  },
  {
    ...
    planet: '太陽',
    q: '職場の人や友人から「あなたってこういう人だよね」と言われることに近いのはどれですか？',
  ...
  },
  {
    ...
    tag: '♂ 火星が動かす — 最初の一手',
    planet: '火星',
    q: '転職活動を始めるなら、あなたの火星が最初に動かすのはどれですか？',
  ...
  // ── BLOCK 6: 冥王星が問う「最後の扉」 ──
  {
    ...
    tag: '🌟 冥王星が照らす — 変容への覚悟',
    planet: '冥王星',
    q: 'すべての星を読み終えた今、あなたはどんな言葉が一番心に響きますか？',
    hint: '冥王星は「変容と再生」を司る惑星。最後の選択が、あなたの星の総意を表しています。',
    opts: [
      { sym: 'Zap',      main: '「もう動くタイミングは来ているかもしれません。あとは踏み出すだけです」', hint: '行動への確信がある',       s: { determination: 4, urgency_add: 3 } },
      { sym: 'Sparkles', main: '「星の示す方向を信じて、まず一歩だけ踏み出してみてくださいね」',         hint: '慎重に、でも動き始めたい', s: { determination: 3, urgency_add: 2 } },
      { sym: 'Moon',     main: '「焦らなくても大丈夫です。準備を整えれば道が開けていくでしょう」',       hint: 'じっくり準備を整えたい',  s: { determination: 2, urgency_add: 1 } },
      { sym: 'Sprout',   main: '「まだ今ではないのかもしれません。今は力を蓄える時期です」',             hint: '今はまだ充電が必要',      s: { determination: 1, urgency_add: 0 } },
    ],
  },
];
...
export const BLOCKS = [
  ...
  { num: 3, title: '木星が照らす「次の場所」',         icon: '♃', questionCount: 9 },
