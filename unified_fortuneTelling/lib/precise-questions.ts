...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    opts: [
      ...
      { sym: 'MapPin', main: '北海道・東北',           hint: '北海道・青森・岩手・宮城・秋田・山形・福島',           s: { area: 'hokkaido_tohoku' } },
      { sym: 'MapPin', main: '関東',                   hint: '東京・神奈川・埼玉・千葉・茨城・栃木・群馬',           s: { area: 'kanto' } },
      { sym: 'MapPin', main: '中部',                   hint: '新潟・富山・石川・福井・山梨・長野・岐阜・静岡・愛知', s: { area: 'chubu' } },
      { sym: 'MapPin', main: '近畿',                   hint: '三重・滋賀・京都・大阪・兵庫・奈良・和歌山',           s: { area: 'kinki' } },
      { sym: 'MapPin', main: '中国地方',               hint: '鳥取・島根・岡山・広島・山口',                         s: { area: 'chugoku' } },
      { sym: 'MapPin', main: '四国',                   hint: '徳島・香川・愛媛・高知',                               s: { area: 'shikoku' } },
      { sym: 'MapPin', main: '九州・沖縄',             hint: '福岡・佐賀・長崎・熊本・大分・宮崎・鹿児島・沖縄',     s: { area: 'kyushu_okinawa' } },
    ],
  },
  {
    block: 3,
